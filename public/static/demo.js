    ...
    return (
        <>
            ...
            <div className={inter.className}>
                <a href="https://api.whatsapp.com/send?phone=9345359547&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Varela%202." class="float" target="_blank">
                ...
                <header>
                    <nav className="navbar header-nav navbar-expand-lg header-nav-light">
                        <div className="container">
                            ...
                            <div className="navbar-toggler" onclick="toggledropdown()">
                                <span></span>
                                <span></span>
                                <span></span>
                            </div>
